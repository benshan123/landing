      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            ...
            <a href="https://github.com/benshan123/wdz/releases/download/v1.1.8-twophone/StealthMate-Setup-1.1.8.exe" className="btn-primary px-6 py-3 rounded-xl font-semibold inline-block w-full text-center hover:opacity-90 transition">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            ...
            <a href="https://github.com/benshan123/wdz/releases/download/v1.1.8-twophone/StealthMate-1.1.8-universal.dmg" className="btn-primary px-6 py-3 rounded-xl font-semibold inline-block w-full text-center hover:opacity-90 transition">
