...
export const translations = {
  zh: {
    ...
    // Hero
    hero_highlight_pitch: '拥有了面试坤，你只需要练习两日半，就可斩获别人练习时长两年半的 offer。',
    ...
    feat_interview_items: ['技术面 / HR 面 / 行为面 模拟练习', '📄 支持上传简历图片，AI 自动解析项目经历与技能', '🎯 面试回答结合你的简历，生成个性化、强相关的参考回答', '本地离线识别，不依赖网络'],
    ...
    pricing_plans: [
      {
        ...
        contactOnly: true,
        duration: '超低价 · 灵活体验',
        features: ['笔试 + 面试全功能', '📱 双机位模式', '📄 简历上传解析', '离线语音识别', '进群享受超低价'],
        highlight: false,
        tag: '✨ 当日体验',
      },
      {
        ...
        price: 29.9,
        duration: '30 天有效',
        features: ['笔试 + 面试全功能', '📱 双机位模式', '📄 简历上传解析', '隐私保护模式', '离线语音识别', '基础客服支持'],
        highlight: false,
        tag: '体验首选',
      },
      {
        ...
        price: 59.9,
        duration: '永久有效',
        features: ['笔试 + 面试全功能', '📱 双机位模式', '📄 简历上传解析', '隐私保护模式', '离线语音识别', '优先客服支持', '持续版本更新', '永久免费升级'],
        highlight: true,
        tag: '🔥 最划算',
      },
    ],
    pricing_buy: '立即购买',
    pricing_buy_contact: '进QQ群商谈',
    pricing_currency: '¥',
    ...
    download_win_spec: 'Windows 10 2004+ · v2.3.9',
    download_win_btn: '快速下载 Windows 版',
    download_win_note: '⚡ 快速下载需要 GitHub 账号',
    download_win_baidu: '百度网盘下载（提取码: 34qu）',
    ...
    download_mac_baidu: '百度网盘下载（提取码: mb8c）',
    ...
    download_android_title: 'Android 配对助手',
    download_android_spec: 'Android · 扫码后直接进入配对页面，无需再次扫码',
    download_android_btn: '快速下载 Android 版',
    download_android_note: '⚡ 快速下载需要 GitHub 账号',
    download_android_baidu: '百度网盘下载（提取码: 84mx）',
    download_android_warn: '⚠️ 安装时请允许安装来自此来源的应用',
  ...
  en: {
    ...
    feat_interview_items: ['Technical / HR / Behavioral Interviews', '📄 Upload resume image — AI auto-parses your experience & skills', '🎯 Answers tailored to your resume for personalized, relevant responses', 'Local Offline Recognition'],
    ...
    pricing_plans: [
      {
        ...
        plan: 'daily',
        price: 0,
        priceText: 'Ask in QQ Group',
        contactOnly: true,
        duration: 'Ultra low price · Flexible',
        features: ['Full Exam + Interview Features', '📱 Dual-Device Mode', '📄 Resume Upload & Parsing', 'Offline Voice Recognition', 'Exclusive price in QQ group'],
        highlight: false,
        tag: '✨ Try Today',
      },
      {
        ...
        price: 29.9,
        duration: '30 days',
        features: ['Full Exam + Interview Features', '📱 Dual-Device Mode', '📄 Resume Upload & Parsing', 'Full Stealth Mode', 'Offline Voice Recognition', 'Basic Support'],
        highlight: false,
        tag: 'Try It Out',
      },
      {
        ...
        features: ['Full Exam + Interview Features', '📱 Dual-Device Mode', '📄 Resume Upload & Parsing', 'Full Stealth Mode', 'Offline Voice Recognition', 'Priority Support', 'Continuous Updates', 'Free Upgrades Forever'],
        highlight: true,
        tag: '🔥 Best Value',
      },
    ],
    pricing_buy: 'Buy Now',
    pricing_buy_contact: 'Ask in QQ Group',
    pricing_currency: '¥',
    ...
    download_win_baidu: 'Baidu Netdisk (Code: 34qu)',
    ...
    download_mac_baidu: 'Baidu Netdisk (Code: mb8c)',
    ...
    download_android_title: 'Android Pairing Assistant',
    download_android_spec: 'Android · Open the pairing page directly after scanning—no second scan needed',
    download_android_btn: 'Download for Android',
    download_android_note: '⚡ Fast download requires GitHub account',
    download_android_baidu: 'Baidu Netdisk (Code: 84mx)',
    download_android_warn: '⚠️ Allow installation from this source when prompted',
