...
export const translations = {
  zh: {
    ...
    download_win_baidu: '百度网盘下载（提取码: 96d9）',
    ...
    download_mac_baidu: '百度网盘下载（提取码: g7eh）',
  ...
  en: {
    ...
    download_win_baidu: 'Baidu Netdisk (Code: 96d9)',
    ...
    download_mac_baidu: 'Baidu Netdisk (Code: g7eh)',
