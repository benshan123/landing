...
export const translations = {
  zh: {
    ...
    download_mac_warn: '⚠️ 首次打开提示「文件已损坏」？请在应用上「右键 → 打开」（不要双击），在弹出的警告里点「打开」即可，无需终端命令。面试模式会自动检测 BlackHole 音频驱动并引导安装。',
  ...
  en: {
    ...
    download_mac_warn: '⚠️ "App is damaged" on first open? Right-click the app → Open (do NOT double-click), then click Open in the warning dialog — no Terminal command needed. Interview mode auto-detects BlackHole audio driver and guides installation.',
