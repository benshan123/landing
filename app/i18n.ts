...
export const translations = {
  zh: {
    ...
    download_mac_warn: '⚠️ 首次打开提示「文件已损坏」？打开终端执行：xattr -cr /Applications/StealthMate\\ 双机位.app，然后重新打开即可。面试模式需安装 BlackHole 音频驱动',
  ...
  en: {
    ...
    download_mac_warn: '⚠️ "App is damaged" on first open? Run in Terminal: xattr -cr /Applications/StealthMate\\ 双机位.app, then reopen. Interview mode requires BlackHole audio driver',
