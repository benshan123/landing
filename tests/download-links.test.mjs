...
test('download section exposes the 2.3.9 desktop installers and Android pairing app', async () => {
  ...
  const expectedPageContent = [
    ...
    'https://pan.baidu.com/s/1QdA-DrpeSCbSL8C1jX5ShQ',
    'https://github.com/benshan123/wdz/releases/download/v3.1/mianshikun-2.3.9-universal.dmg',
    'https://pan.baidu.com/s/1XUua0GcvrfX5FoSy4p7EsQ',
  ...
  for (const value of ['2.3.9', 'zpk1', 'tqht', '84mx', '扫码后直接进入配对页面，无需再次扫码', 'Open the pairing page directly after scanning—no second scan needed']) {
